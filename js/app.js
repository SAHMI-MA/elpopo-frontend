...
//    calendlyUrl: 'https://calendly.com/aji/30min',
    capacityPercent: 78,
    stripePublicKey: 'pk_test_51Thu5BFfwY7tFvmLRss0OGnxKrIfzrqBtqK48Ifd93BoZJ4kkJX1Wn5gz0xhcP6U3oAPupbkkBZ47ZKCcom94AdD00eS9BiDit',
 ...
 const TIERS = [
  {
    level: 'Offer 01',
    name: 'The Frame Game',
    product: 'The Frame Game',
    productKey: 'frame-game',
    amountCents: 4700,
    icon: '🎯',
    price: '$47',
    period: 'instant access',
    desc: 'Learn how to frame every conversation and control the sales direction instantly.',
    features: [
      'Instant digital access',
      'Conversation control frameworks',
      'Real-world examples'
    ],
    cta: 'Buy Now',
  },
  {
    ...
    product: '7-Layer Blueprint',
    productKey: '7-layer-blueprint',
    amountCents: 9700,
    icon: '🧠',
    price: '$97',
    period: 'instant access',
    desc: 'The complete 7-layer persuasion system used in high-ticket closing.',
    features: [
  ...
  },
  {
    ...
    product: 'Objection Reframe Playbook',
    productKey: 'objection-reframe-playbook',
    amountCents: 4700,
    icon: '🛡️',
    price: '$47',
    period: 'instant access',
    desc: 'Turn every objection into a buying signal using proven scripts.',
    features: [
      '50+ objection scripts',
      'Real closing dialogues',
      'Reframe psychology'
    ],
    cta: 'Buy Now',
  },
  {
    ...
    product: 'Elite Closer Identity Workbook',
    productKey: 'elite-closer-identity-workbook',
    amountCents: 2700,
    icon: '📘',
    price: '$27',
    period: 'instant access',
    desc: 'Rewire your identity to think and act like a top closer.',
    features: [
      'Identity exercises',
      'Daily mindset drills',
      'Closer psychology reset'
    ],
    cta: 'Buy Now',
  },
  {
    ...
    product: 'The Closer’s Code',
    productKey: 'closers-code',
    amountCents: 6700,
    icon: '🔑',
    price: '$67',
    period: 'instant access',
    desc: 'The internal rules every elite closer follows to dominate sales.',
    features: [
      'Core closing principles',
      'Behavior frameworks',
      'Elite discipline system'
    ],
    cta: 'Buy Now',
  },
  {
    level: 'Offer 06',
    name: 'Private 1-Hour Closing Diagnosis',
    product: 'Private 1-Hour Closing Diagnosis With Tarik',
    productKey: 'closing-diagnosis',
    amountCents: 49700,
    icon: '👑',
    price: '$497',
    period: '1-on-1 session',
    desc: 'Live breakdown of your closing process with personalized fixes.',
    features: [
      'Live diagnosis session',
      'Personalized feedback',
      'Action plan to increase closing rate'
    ],
    cta: 'Apply Now',
  },
];
